...
import com.ichi3.compat.customtabs.CustomTabsFallback;
import com.ichi3.compat.customtabs.CustomTabsHelper;
...
public class CompatV16 extends CompatV15 implements Compat {
    ...
    public Uri getExportUri(Context context, File file) {
        ...
        return FileProvider.getUriForFile(context, "com.ichi3.anki.apkgfileprovider", file);
    }
}