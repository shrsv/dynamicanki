...
import com.ichi3.anki.exception.StorageAccessException;
import com.ichi3.anki.services.BootService;
import com.ichi3.anki.services.NotificationService;
import com.ichi3.compat.CompatHelper;
import com.ichi3.libanki.Collection;
import com.ichi3.libanki.Utils;
import com.ichi3.libanki.hooks.AdvancedStatistics;
import com.ichi3.libanki.hooks.ChessFilter;
import com.ichi3.libanki.hooks.HebrewFixFilter;
import com.ichi3.libanki.hooks.Hooks;
import com.ichi3.preferences.NumberRangePreference;
import com.ichi3.themes.Themes;
import com.ichi3.ui.AppCompatPreferenceActivity;
import com.ichi3.ui.ConfirmationPreference;
import com.ichi3.ui.SeekBarPreference;
import com.ichi3.utils.LanguageUtil;
...
public class Preferences extends AppCompatPreferenceActivity implements PreferenceContext, OnSharedPreferenceChangeListener {
    ...
    public static Intent getPreferenceSubscreenIntent(Context context, String subscreen) {
        ...
        i.putExtra(PreferenceActivity.EXTRA_SHOW_FRAGMENT, "com.ichi3.anki.Preferences$SettingsFragment");
    ...
    private void initSubscreen(String action, PreferenceContext listener) {
        ...
        switch (action) {
            ...
            case "com.ichi3.anki.prefs.custom_buttons":
                ...
                break;
            case "com.ichi3.anki.prefs.advanced":
                ...
                customSyncServerPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi3.anki.prefs.custom_sync_server");
                    startActivity(i);
                    return true;
                });
                ...
                advancedStatisticsPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi3.anki.prefs.advanced_statistics");
                    startActivity(i);
                    return true;
                });
                ...
                break;
            case "com.ichi3.anki.prefs.custom_sync_server":
                ...
                break;
            case "com.ichi3.anki.prefs.advanced_statistics":
        ...
        try {
            ...
            switch (key) {
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.ichi3.anki.provider.CardContentProvider");
