package com.ichi3.anki.services;
...
public class BootService extends BroadcastReceiver {
    ...
    /**
     * This service is also run when the app is started (from {@link com.ichi3.anki.AnkiDroidApp},
    ...
    private void scheduleDeckReminder(Context context) {
        ...
        try {
            for (JSONObject deck : CollectionHelper.getInstance().getCol(context).getDecks().all()) {
                ...
                // go through each deckConfiguration with a reminder
                if (deckConfiguration.has("reminder")) {
                    ...
                    if (reminder.getBoolean("enabled")) {
                        ...
                        // get hour and minute attributes for the reminder
                        ...
                        // use the calendar instance to set a repeating alarm at that time, for the given
                        // deck
