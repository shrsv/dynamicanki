        ...
        pendingRunnable = () -> {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.nav_stats: {
                    ...
                    Toast.makeText(context, "created splitinstallmanager", Toast.LENGTH_LONG).show();
...
// Creates a request to install a module.
                    SplitInstallRequest request =
                            SplitInstallRequest
                                    ...
                                    .build();
                    // Toast.makeText(context, "created request object", Toast.LENGTH_LONG).show();


                    SplitInstallStateUpdatedListener listener = state -> {
                        Toast.makeText(context, "in listener at least", Toast.LENGTH_SHORT).show();
                        if (state.sessionId() == mySessionId) {
                            // Read the status of the request to handle the state update.
                            if(state.status() == SplitInstallSessionStatus.INSTALLED) {
                                Toast.makeText(context, "MODULE INSTALLED!", Toast.LENGTH_LONG).show();
                                Toast.makeText(context, "addition successful", Toast.LENGTH_LONG);
                                // Toast.makeText(context, String.join(", ", splitInstallManager.getInstalledModules()), Toast.LENGTH_LONG);
                                ...
                                intent.setClassName(getPackageName(), "com.cachedthought.dynamicstats.Statistics");
                                //Context context = getApplicationContext()
                                context.startActivity(intent);
                            } else if (state.status() == SplitInstallSessionStatus.DOWNLOADING) {
                                Toast.makeText(context, "MODULE DOWNLOADING!", Toast.LENGTH_LONG).show();
                            } else {
                                Toast.makeText(context, "SOMETHING ELSE HAPPENED!", Toast.LENGTH_LONG).show();
                            }
                        }
                    };
                    ...
                    splitInstallManager
                            ...
                            .addOnFailureListener(exception -> {
                                Toast.makeText(context, "overallfailure" + exception.getMessage(), Toast.LENGTH_LONG);
