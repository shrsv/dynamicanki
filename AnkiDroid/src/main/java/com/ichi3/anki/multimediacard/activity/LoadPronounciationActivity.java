...
import com.ichi3.anki.multimediacard.beolingus.parsing.BeolingusParser;
import com.ichi3.anki.multimediacard.language.LanguageListerBeolingus;
import com.ichi3.anki.runtimetools.TaskOperations;
import com.ichi3.anki.web.HttpFetcher;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static String EXTRA_SOURCE = "com.ichi3.anki.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static String EXTRA_PRONUNCIATION_FILE_PATH = "com.ichi3.anki.LoadPronounciationActivity.extra.pronun.file.path";
