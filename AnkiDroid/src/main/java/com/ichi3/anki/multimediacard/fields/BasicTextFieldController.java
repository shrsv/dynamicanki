...
package com.ichi3.anki.multimediacard.fields;
...
import com.ichi3.anki.multimediacard.activity.LoadPronounciationActivity;
import com.ichi3.anki.multimediacard.activity.PickStringDialogFragment;
import com.ichi3.anki.multimediacard.activity.TranslationActivity;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    /*
     * (non-Javadoc)
     * @see com.ichi3.anki.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started
