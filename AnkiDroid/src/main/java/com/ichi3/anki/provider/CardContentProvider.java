...
package com.ichi3.anki.provider;
...
import com.ichi3.anki.BuildConfig;
import com.ichi3.anki.CollectionHelper;
import com.ichi3.anki.FlashCardsContract;
import com.ichi3.anki.FlashCardsContract.CardTemplate;
...
import static com.ichi3.anki.FlashCardsContract.READ_WRITE_PERMISSION;
...
//                break;
     ...
     *
     * For example: content://com.ichi3.anki.flashcards/notes?deckId=1234567890123
     *
    ...
    private int bulkInsertNotes(ContentValues[] valuesArr, long deckId) {
        ...
        try {
            ...
            for (int i = 0; i < valuesArr.length; i++) {
                ...
                // Create empty note
                com.ichi3.libanki.Note newNote = new com.ichi3.libanki.Note(col, model); // for some reason we cannot pass modelId in here
                // Set fields
                // Check that correct number of flds specified
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case NOTES: {
                ...
                String tags = values.getAsString(FlashCardsContract.Note.TAGS);
                // Create empty note
                com.ichi3.libanki.Note newNote = new com.ichi3.libanki.Note(col, col.getModels().get(modelId));
                // Set fields
                String[] fldsArray = Utils.splitFields(flds);
                // Check that correct number of flds specified
                if (fldsArray.length != newNote.getFields().length) {
