...
import com.ichi3.async.CollectionLoader;
import com.ichi3.compat.customtabs.CustomTabActivityHelper;
...
public class AnkiActivity extends AppCompatActivity implements SimpleMessageDialog.SimpleMessageDialogListener {
    ...
    public void showProgressBar() {
        ProgressBar progressBar = (ProgressBar) findViewById(com.ichi3.anki.R.id.progress_bar);
        if (progressBar != null) {
    ...
    public void showSimpleNotification(String title, String message, NotificationChannels.Channel channel) {
        ...
        if (Integer.parseInt(prefs.getString("minimumCardsDueForNotification", "0")) <= 1000000) {
            ...
            String ticker = title;
            if (title.equals(getResources().getString(com.ichi3.anki.R.string.app_name))) {
                ticker = message;
            }
            // Build basic notification
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this,
                    NotificationChannels.getId(channel))
                    .setSmallIcon(com.ichi3.anki.R.drawable.ic_stat_notify)
                    .setContentTitle(title)
                    .setContentText(message)
                    .setColor(ContextCompat.getColor(this, com.ichi3.anki.R.color.material_light_blue_500))
