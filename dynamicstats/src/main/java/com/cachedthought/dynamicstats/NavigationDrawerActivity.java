...
public abstract class NavigationDrawerActivity extends AnkiActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void initNavigationDrawer(View mainView) {
        ...
        mDrawerLayout = mainView.findViewById(com.ichi3.anki.R.id.drawer_layout);
        // set a custom shadow that overlays the main content when the drawer opens
        mDrawerLayout.setDrawerShadow(com.ichi3.anki.R.drawable.drawer_shadow, GravityCompat.START);
        // Force transparent status bar with primary dark color underlayed so that the drawer displays under status bar
        CompatHelper.getCompat().setStatusBarColor(getWindow(), ContextCompat.getColor(this, com.ichi3.anki.R.color.transparent));
        mDrawerLayout.setStatusBarBackgroundColor(Themes.getColorFromAttr(this, com.ichi3.anki.R.attr.colorPrimaryDark));
        // Setup toolbar and hamburger
        mNavigationView = mDrawerLayout.findViewById(com.ichi3.anki.R.id.navdrawer_items_container);
        mNavigationView.setNavigationItemSelectedListener(this);
        Toolbar toolbar = mainView.findViewById(com.ichi3.anki.R.id.toolbar);
        if (toolbar != null) {
        ...
        View actionLayout = mNavigationView.getMenu().findItem(com.ichi3.anki.R.id.nav_night_mode).getActionView();
        mNightModeSwitch = actionLayout.findViewById(com.ichi3.anki.R.id.switch_compat);
    ...
    public boolean onNavigationItemSelected(final MenuItem item) {
        ...
        pendingRunnable = () -> {
            ...
            switch (item.getItemId()) {
                case com.ichi3.anki.R.id.nav_decks: {
                ...
                case com.ichi3.anki.R.id.nav_browser:
                    openCardBrowser();
                    break;
                case com.ichi3.anki.R.id.nav_stats: {
...
// Creates a request to install a module.
                    ...
                    splitInstallManager
                            ...
                            .addOnSuccessListener(sessionId -> {
                                Log.d("MSG" ,"onNavigationItemSelected: yay!");
                                Log.d("YAY", String.join(", ", splitInstallManager.getInstalledModules()));
                                Toast.makeText(context, "Successfully downloaded module", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(Intent.ACTION_VIEW);
                                intent.setClassName(getPackageName(), "com.cachedthought.dynamicstats.MainActivity");
                                //Context context = getApplicationContext()
                                context.startActivity(intent);

                            })
                            .addOnFailureListener(exception -> {
                                Log.d("MSG", "overallfailure");
                            });
                ...
                case com.ichi3.anki.R.id.nav_night_mode:
                    mNightModeSwitch.performClick();
                    break;
                case com.ichi3.anki.R.id.nav_settings:
                    ...
                    break;
                case com.ichi3.anki.R.id.nav_help:
                    openUrl(Uri.parse(AnkiDroidApp.getManualUrl()));
                    break;
                case com.ichi3.anki.R.id.nav_feedback:
