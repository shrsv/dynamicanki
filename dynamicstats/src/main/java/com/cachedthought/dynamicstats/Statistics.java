...
import com.ichi3.anim.ActivityTransitionAnimation;
import com.ichi3.anki.CollectionHelper;
import com.ichi3.anki.stats.AnkiStatsTaskHandler;
import com.ichi3.anki.stats.ChartView;
import com.ichi3.anki.widgets.DeckDropDownAdapter;
import com.ichi3.libanki.Collection;
import com.ichi3.libanki.Stats;
import com.ichi3.ui.SlidingTabLayout;
...
public class Statistics extends NavigationDrawerActivity implements DeckDropDownAdapter.SubtitleListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ichi3.anki.R.layout.activity_anki_stats);
    ...
    protected void onCollectionLoaded(Collection col) {
        ...
        mActionBarSpinner = (Spinner) findViewById(com.ichi3.anki.R.id.toolbar_spinner);
        ...
        mViewPager = (ViewPager) findViewById(com.ichi3.anki.R.id.pager);
        mViewPager.setAdapter(mSectionsPagerAdapter);
        mViewPager.setOffscreenPageLimit(8);
        slidingTabLayout = (SlidingTabLayout) findViewById(com.ichi3.anki.R.id.sliding_tabs);
    ...
    protected void onResume() {
        Timber.d("onResume()");
        selectNavigationItem(com.ichi3.anki.R.id.nav_stats);
        super.onResume();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.ichi3.anki.R.menu.anki_stats, menu);
        return true;
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        switch (mTaskHandler.getStatType()) {
            case TYPE_MONTH:
                MenuItem monthItem = menu.findItem(com.ichi3.anki.R.id.item_time_month);
                monthItem.setChecked(true);
                break;
            case TYPE_YEAR:
                MenuItem yearItem = menu.findItem(com.ichi3.anki.R.id.item_time_year);
                yearItem.setChecked(true);
                break;
            case TYPE_LIFE:
                MenuItem lifeItem = menu.findItem(com.ichi3.anki.R.id.item_time_all);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            case com.ichi3.anki.R.id.item_time_month:
                ...
                return true;
            case com.ichi3.anki.R.id.item_time_year:
                if (item.isChecked()) item.setChecked(false);
                else item.setChecked(true);
                ...
                return true;
            case com.ichi3.anki.R.id.item_time_all:
                if (item.isChecked()) item.setChecked(false);
                else item.setChecked(true);
                ...
                return true;
            case com.ichi3.anki.R.id.action_time_chooser:
                //showTimeDialog();
                return true;
        }
    ...
    public String getSubtitleText() {
        return getResources().getString(com.ichi3.anki.R.string.statistics);
    }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case TODAYS_STATS_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_overview).toUpperCase(l);
                case FORECAST_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_forecast).toUpperCase(l);
                case REVIEW_COUNT_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_review_count).toUpperCase(l);
                case REVIEW_TIME_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_review_time).toUpperCase(l);
                case INTERVALS_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_review_intervals).toUpperCase(l);
                case HOURLY_BREAKDOWN_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_breakdown).toUpperCase(l);
                case WEEKLY_BREAKDOWN_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_weekly_breakdown).toUpperCase(l);
                case ANSWER_BUTTONS_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_answer_buttons).toUpperCase(l);
                case CARDS_TYPES_TAB_POSITION:
                    return getString(com.ichi3.anki.R.string.stats_cards_types).toUpperCase(l);
            }
            return null;
        }
    }
    ...
    public static class ChartFragment extends StatisticFragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(com.ichi3.anki.R.layout.fragment_anki_stats, container, false);
            mChart = (ChartView) rootView.findViewById(com.ichi3.anki.R.id.image_view_chart);
            if (mChart == null) {
            ...
            mProgressBar = (ProgressBar) rootView.findViewById(com.ichi3.anki.R.id.progress_bar_stats);
            ...
            if (mDeckId != Stats.ALL_DECKS_ID) {
                ...
                if (sIsSubtitle) {
                    ((AppCompatActivity) getActivity()).getSupportActionBar().setSubtitle(com.ichi3.anki.R.string.stats_deck_collection);
                } else {
                    getActivity().setTitle(getResources().getString(com.ichi3.anki.R.string.stats_deck_collection));
                }
            }
            return rootView;
        }
    ...
    public static class OverviewStatisticsFragment extends StatisticFragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            setHasOptionsMenu(true);
            View rootView = inflater.inflate(com.ichi3.anki.R.layout.fragment_anki_stats_overview, container, false);
            ...
            mWebView = (WebView) rootView.findViewById(com.ichi3.anki.R.id.web_view_stats);
            if (mWebView == null) {
                Timber.d("mChart null!");
            } else {
                Timber.d("mChart is not null!");
            ...
            mProgressBar = (ProgressBar) rootView.findViewById(com.ichi3.anki.R.id.progress_bar_stats_overview);
            ...
            if (mDeckId != Stats.ALL_DECKS_ID) {
                ...
                if (sIsSubtitle) {
                    ...
                    getActivity().setTitle(com.ichi3.anki.R.string.stats_deck_collection);
                }
            }
            return rootView;
        }
